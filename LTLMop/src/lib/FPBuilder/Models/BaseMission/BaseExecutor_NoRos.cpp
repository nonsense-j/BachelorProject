...
namespace Ref {
    ...
    )
  {
    ...
    // // check whether the actions are finished
    // if (this->curActions.size() == this->doneActionsNum) {
    ...
    )
  {
    if (action.compare("attack") == 0)
        this->resCap_attack_out_out(0, flag);
    if (action.compare("attack_over") == 0)
        this->resCap_attack_over_out_out(0, flag);
    if (action.compare("take_photo") == 0)
        this->resCap_take_photo_out_out(0, flag);
  }

module Ref {
  ...
  instance resCapMove: Ref.ResCapMove base id 0x1000 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100

  instance resCap_attack: Ref.ResCap_attack base id 0x1100 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100

  instance resCap_attack_over: Ref.ResCap_attack_over base id 0x1200 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100

  instance resCap_take_photo: Ref.ResCap_take_photo base id 0x1300 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100

module Ref {
  ...
  topology Ref {
    ...
    connections ResCap {
      ...
      resCapStart.resCapActStatusout  -> resCapExecutor.resCapActStatusin
      resCapExecutor.resCapMoveout  -> resCapMove.resCapMovein
      resCapMove.resCapActStatusout  -> resCapExecutor.resCapActStatusin
      resCapExecutor.resCap_attack_out  -> resCap_attack.resCap_attack_in
      resCap_attack.resCapActStatusout  -> resCapExecutor.resCapActStatusin
      resCapExecutor.resCap_attack_over_out  -> resCap_attack_over.resCap_attack_over_in
      resCap_attack_over.resCapActStatusout  -> resCapExecutor.resCapActStatusin
      resCapExecutor.resCap_take_photo_out  -> resCap_take_photo.resCap_take_photo_in
      resCap_take_photo.resCapActStatusout  -> resCapExecutor.resCapActStatusin
